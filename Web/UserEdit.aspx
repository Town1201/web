...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(reader.Read())
        {
            idTxt.Text = reader.GetString(reader.GetOrdinal("UserID"));
            userTxt.Text = reader.GetString(reader.GetOrdinal("UserName"));
            pwdTxt.Text = reader.GetString(reader.GetOrdinal("UserPwd"));
            addrTxt.Text = reader.GetString(reader.GetOrdinal("UserAddr"));
            gradeTxt.Text = reader.GetString(reader.GetOrdinal("UserGrade"));
            sexTxt.Text = reader.GetString(reader.GetOrdinal("UserSex"));
            specTxt.Text = reader.GetString(reader.GetOrdinal("UserSpec"));
            ageTxt.Text = reader.GetString(reader.GetOrdinal("UserAge"));
        }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        model.UserID = idTxt.Text;
        model.UserName = userTxt.Text;
        model.UserPwd = pwdTxt.Text;
        model.UserSex = sexTxt.Text;
        model.UserSpec = specTxt.Text;
        model.UserAge = ageTxt.Text;
        model.UserAddr = addrTxt.Text;
        model.UserGrade = gradeTxt.Text;
...
<div class="content" runat="server" style="align-content:center" >
       ...
       <div class="center">
    <asp:Label ID="Label1" runat="server" Text="账号："></asp:Label><asp:TextBox ID="idTxt" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="Label2" runat="server" Text="用户："></asp:Label><asp:TextBox ID="userTxt" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="Label3" runat="server" Text="密码："></asp:Label><asp:TextBox ID="pwdTxt" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="Label4" runat="server" Text="性别："></asp:Label><asp:TextBox ID="sexTxt" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="Label5" runat="server" Text="年龄："></asp:Label><asp:TextBox ID="ageTxt" runat="server" ></asp:TextBox>
        <br />
        <asp:Label ID="Label6" runat="server" Text="专业："></asp:Label><asp:TextBox ID="specTxt" runat="server" ></asp:TextBox>
        <br />
        <asp:Label ID="Label7" runat="server" Text="绩点："></asp:Label><asp:TextBox ID="gradeTxt" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="Label8" runat="server" Text="地址："></asp:Label><asp:TextBox ID="addrTxt" runat="server"></asp:TextBox> 
        <br />
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="编辑个人信息" />
