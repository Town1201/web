...
<div class="imrcmain0 imgl" style="width: 993px; z-index: 999999; position: relative; top: 0px; left: 0px; height: 43px;">
    <div class="imcm imde" id="imouter0">
        <ul id="imenus0">
            <li class="imatm" style="width: 99px;"><a class="auto-style8" href="WebForm_Main_CUIT.aspx">&nbsp;<span class="imea imeam"></span>学校首页</a>
...
<div class="content" >
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Horizontal" OnSelectedIndexChanged="select" Width="940px" AllowPaging="True" PageSize="15">
            <Columns>
                ...
                <asp:CommandField ShowSelectButton ="true" ButtonType="Image" HeaderStyle-Width="10" SelectImageUrl="~/images/more.png" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBwebConnectionString %>" SelectCommand="SELECT [NewsID], [NewsTitle], [NewsTime] FROM [T_News]"></asp:SqlDataSource>
