...
<script runat="server">
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        model.UserPwd = TextBox2.Text;
        BLL.User bll = new BLL.User();
        int str = bll.SelectUser(model);
...
<div class="imrcmain0 imgl" style="width: 993px; z-index: 999999; position: relative; top: 0px; left: 0px; height: 43px;">
    <div class="imcm imde" id="imouter0">
        <ul id="imenus0">
            <li class="imatm" style="width: 99px;"><a class="" href="#"><span class="imea imeam"><span></span></span>学校首页</a>
